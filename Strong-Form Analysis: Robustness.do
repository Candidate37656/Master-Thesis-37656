...
* 1) Odds
egen maxhome = rowmax(b365h bfh bwh iwh lbh psh vch whh)
egen maxdraw = rowmax(b365d bfd bwd iwd lbd psd vcd whd)
egen maxaway = rowmax(b365a bfa bwa iwa lba psa vca wha)

*2) Market Implied Probabilities
generate p_home = 1/maxhome
generate p_draw = 1/maxdraw
generate p_away = 1/maxaway
...
***************************************************
*Maximum Odds (Normalised Probabilities)
***************************************************
...
*Linear Diagnostics
***************************************************
regress epsilon home away norm_ season_18_19-season_24_25 div_E0 div_I1 div_SP1

*1) Homoscedasticity: Breusch Pagan and White Test
estat hettest norm_ home away season_18_19-season_24_25 div_E0 div_I1 div_SP1, iid rhs

estat imtest, white

*2) Normality Assumption
regress epsilon home away norm_ season_18_19-season_24_25 div_E0 div_I1 div_SP1 [aweight=w]
predict double u, residual
predict double h, hat
scalar MSE = e(rss)/e(df_r)
gen double rstd = u/sqrt((MSE*(1-h))/w)
...
*3) Ramsey Test: Omitted non-linear Relationship?
regress epsilon home away norm_ season_18_19-season_24_25 div_E0 div_I1 div_SP1 [aweight=w],vce(cluster match_id)
...
*2) Individual Leagues
regress epsilon home away norm_ season_18_19-season_24_25 if div_D1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", replace ctitle("Bundesliga")
test home away norm_
test season_18_19 season_19_20 season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away norm_ season_18_19-season_24_25 if div_E0==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Premier League")
test home away norm_
test season_18_19 season_19_20 season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
...
regress epsilon home away norm_ season_18_19-season_24_25 if div_I1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Serie A")
test home away norm_
test season_18_19 season_19_20 season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
...
* 1) Odds
egen avghome = rowmean(b365ch bwch iwch psch vcch whch)
egen avgaway = rowmean(b365ca bwca iwca psca vcca whca)
egen avgdraw = rowmean(b365cd bwcd iwcd pscd vccd whcd)
...
drop if (season_17_18==1 | season_18_19==1)
...
*Linear Diagnostics
***************************************************
regress epsilon home away p_ season_20_21-season_24_25 div_E0 div_I1 div_SP1

*1) Homoscedasticity: Breusch Pagan and White Test
estat hettest p_ home away season_20_21-season_24_25 div_E0 div_I1 div_SP1, iid rhs

estat imtest, white

*2) Normality Assumption
regress epsilon home away p_ season_20_21-season_24_25 div_E0 div_I1 div_SP1 [aweight=w]
predict double u, residual
predict double h, hat
scalar MSE = e(rss)/e(df_r)
gen double rstd = u/sqrt((MSE*(1-h))/w)
...
outreg2 using "WLS_final_.doc", replace
test home away p_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
test div_E0 div_I1 div_SP1

*2) Individual Leagues
regress epsilon home away p_ season_20_21-season_24_25 if div_D1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", replace ctitle("Bundesliga")
test home away p_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away p_ season_20_21-season_24_25 if div_E0==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Premier League")
test home away p_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away p_ season_20_21-season_24_25 if div_SP1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("La Liga")
test home away p_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away p_ season_20_21-season_24_25 if div_I1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Serie A")
test home away p_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
...
*Linear Diagnostics
***************************************************
regress epsilon home away norm_ season_20_21-season_24_25 div_E0 div_I1 div_SP1

*1) Homoscedasticity: Breusch Pagan and White Test
estat hettest norm_ home away season_20_21-season_24_25 div_E0 div_I1 div_SP1, iid rhs

estat imtest, white

*2) Normality Assumption
regress epsilon home away norm_ season_20_21-season_24_25 div_E0 div_I1 div_SP1 [aweight=w]
predict double u, residual
predict double h, hat
scalar MSE = e(rss)/e(df_r)
gen double rstd = u/sqrt((MSE*(1-h))/w)
...
*3) Ramsey Test: Omitted non-linear Relationship?
regress epsilon home away norm_ season_20_21-season_24_25 div_E0 div_I1 div_SP1 [aweight=w],vce(cluster match_id)
...
***************************************************
*1) Pooled Regression
regress epsilon home away norm_ season_20_21-season_24_25 div_E0 div_I1 div_SP1 [aweight=w], cluster(match_id)
outreg2 using "WLS_final_.doc", replace
test home away norm_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
test div_E0 div_I1 div_SP1
...
*2) Individual Leagues
regress epsilon home away norm_ season_20_21-season_24_25 if div_D1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", replace ctitle("Bundesliga")
test home away norm_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away norm_ season_20_21-season_24_25 if div_E0==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Premier League")
test home away norm_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away norm_ season_20_21-season_24_25 if div_SP1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("La Liga")
test home away norm_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25

regress epsilon home away norm_ season_20_21-season_24_25 if div_I1==1 [aweight=w], cluster(match_id) 
outreg2 using "WLS_final_leagues.doc", append ctitle("Serie A")
test home away norm_
test season_20_21 season_21_22 season_22_23 season_23_24 season_24_25
